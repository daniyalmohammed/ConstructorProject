...
class Vertex {
	public:
		vector<vector<int>> all_neighbours = {{1,3},{0,4},
                        ...
                        {49,53},{50,52}};
	    vector<vector<int>> all_roads = {{0,1},{0,2},
			{3,5},{1,3,6},{2,4,7},{4,8},
		...
		int pos;
		int residenceLevel;
		// string res_types[4] = {to_string(index),"B","H","T"};
		// string builders[4] = {"B","R","O","Y"};
		// string colours[4] = {"Blue","Red","Orange","Yellow"};
		// int owner_index;
		vector<int> neighbor = all_neighbours[index];
		vector<int> my_roads = all_roads[index];
		// Vertex();
		bool canBuild;
		void upgrade();
